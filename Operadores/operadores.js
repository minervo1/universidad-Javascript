...
//*operadores relacinales, tambien nos devolvera  un valor booleano
console.log('<, >, <=, >=');
...
//con este operador (ternario) es paresido a realizar un bloque if. Importante: recordemos que un operador es en efecto una expresion por lo tanto este operador ternario es una expresion, lo que significa que podemos asigar este 'valor' a una variable.
//si quisieramos hacer lo mismo con un bloque if la variable debe estar fuera del bloque
//Importante: de hecho podemos usar este operador para introducirlo en una plantilla literal que recordemos acepta cualquier tipo de expresion. 
let expresion = 3 > 2;
